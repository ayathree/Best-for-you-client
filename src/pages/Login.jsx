...
const Login = () => {
    ...
    return (
        ...
        <div className="flex items-center justify-between mt-4">
            ...
            <a  className="text-xs text-center text-white uppercase dark:text-gray-400 hover:underline">
        ...
        <p className="mt-8  font-bold text-center text-gray-400"> Do not have an account? <Link to={'/register'} className="font-bold text-blue-700 dark:text-gray-200 hover:underline">Register</Link></p>
    </div>
    );
};
