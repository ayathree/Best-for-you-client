...
const Queries = () => {
    ...
    return (
       ...
       <form onSubmit={handleSearch} className="join">
           ...
           <button className="btn join-item text-white bg-green-500">Search</button>
       </form>
       <div className={`grid  ${gridLayout}   justify-center items-center gap-10`}>
           {infos.map(info => (
               <div key={info._id} className="mt-16 p-2 card hidden lg:block  overflow-hidden cover rounded-lg shadow-lg dark:bg-gray-800">
                   ...
                   <div className="px-8 py-4  rounded-lg  dark:bg-gray-800">
                       ...
                       <div className="flex justify-end">
                           <a href="#" className="text-lg font-medium text-white dark:text-blue-300" tabIndex="0" role="link">{info.queryUser.name}</a>
                       </div>
       ...
       <div className={`grid lg:hidden lg:grid-cols-${gridLayout} md:grid-cols-${gridLayout}  justify-center items-center gap-10`}>
           {infos.map(info => (
       ...
       <div className="lg:flex lg:justify-center hidden  lg:block lg:items-center mt-20 gap-10">
